...
(function($){
	...
	$.fn.supersized = function() {
		...
		$(window).bind("load", function(){
			...
			if (options.slide_captions == 1) $('#make').html($('#supersize .activeslide').find('img').attr('make'));
			if (options.slide_captions == 1) $('#origin').html($('#supersize .activeslide').find('img').attr('origin'));
			...
			if (options.slideshow == 1){
				...
				slideshow_interval = "nextslide()";//setInterval("nextslide()", options.slide_interval);
				if (options.navigation == 1){ //Skip if no navigation
					...
					$('#nextslide img').hover(function() {
						//if($.paused == true) return false;
					   	$(this).attr("src", "images/right_arrow_dull.png");
					}, function(){
						//if($.paused == true) return false;
					...
					$('#prevslide img').hover(function() {
						//if($.paused == true) return false; 
					    $(this).attr("src", "images/left_arrow_dull.png");
					}, function(){
						//if($.paused == true) return false;
	...
	function nextslide() {
		...
		if (options.slide_captions == 1) $('#make').html($(nextslide).find('img').attr('make'));
		if (options.slide_captions == 1) $('#origin').html($(nextslide).find('img').attr('origin'));
